...
_RESPONSEINTEGRATIONTOKEN.fields_by_name['token'].has_options = True
_RESPONSEINTEGRATIONTOKEN.fields_by_name['token']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\212\3520\010\n\006danger'))
_RESPONSEINTEGRATIONTOKEN.fields_by_name['url'].has_options = True
_RESPONSEINTEGRATIONTOKEN.fields_by_name['url']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\212\3520\010\n\006danger'))
_RESPONSEINTEGRATIONTOKEN.has_options = True
_RESPONSEINTEGRATIONTOKEN._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\342?\032\n\030im.dlg.grpc.GrpcResponse'))
_REQUESTGETINTEGRATIONTOKEN.fields_by_name['group_peer'].has_options = True
_REQUESTGETINTEGRATIONTOKEN.fields_by_name['group_peer']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\212\3520\t\n\007visible'))
_REQUESTGETINTEGRATIONTOKEN.has_options = True
_REQUESTGETINTEGRATIONTOKEN._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\342?\031\n\027im.dlg.grpc.GrpcRequest'))
_REQUESTREVOKEINTEGRATIONTOKEN.fields_by_name['group_peer'].has_options = True
_REQUESTREVOKEINTEGRATIONTOKEN.fields_by_name['group_peer']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\212\3520\t\n\007visible'))
_REQUESTREVOKEINTEGRATIONTOKEN.has_options = True
_REQUESTREVOKEINTEGRATIONTOKEN._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\342?\031\n\027im.dlg.grpc.GrpcRequest'))
