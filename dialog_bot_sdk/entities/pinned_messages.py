...
from dialog_api import pinned_messages_pb2
...
class UpdatePinnedMessagesChanged:
    ...
    @classmethod
    def from_api(cls, update: pinned_messages_pb2.UpdatePinnedMessagesChanged) -> 'UpdatePinnedMessagesChanged':
    ...
    def __dict__(self):
        return {
            ...
            "mids": [x.__dict__() for x in self.mids],
            "clock": self.clock,
            "prev_clock": self.prev_clock,
        }

    def __str__(self):
        return "UpdatePinnedMessagesChanged({})".format(self.__dict__())
